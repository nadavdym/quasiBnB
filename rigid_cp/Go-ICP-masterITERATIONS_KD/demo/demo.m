...
cd '/ytmp/cloud/nadavd/dropbox/Dropbox/globalICP/code/Go-ICP-masterITERATIONS/';
...
if strcmp(data, 'random points')
    cmd = [cmd ' demo/model_rand.txt demo/data_rand.txt 100 demo/config.txt demo/output.txt'];
    model = readpoints('demo/model_rand.txt');
    data = readpoints('demo/data_rand.txt');
else
