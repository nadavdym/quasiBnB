...
int main(int argc, char** argv)
{
    ...
    cout << "Iteration counts (outer  inner_ub  inner_lb):" << endl;
    cout << goicp.count_outer << "\t" << goicp.count_inner_ub << "\t" <<goicp.count_inner_lb << endl;
    ...
    ofile << goicp.count_outer << "\t" << goicp.count_inner_ub << "\t" <<goicp.count_inner_lb << endl;
	ofile.close();
